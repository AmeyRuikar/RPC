...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, BANK, SWISS_BANK, bank_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (BANK, SWISS_BANK, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, BANK, SWISS_BANK, bank_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (BANK, SWISS_BANK, tcp).");
		exit(1);
	}
